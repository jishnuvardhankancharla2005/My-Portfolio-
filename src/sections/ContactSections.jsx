...
import { Mail, Send, CheckCircle, MessageSquare, Headphones } from 'lucide-react';
...
const ContactSections = () => {
  ...
  const { ref: detailsRef, handlers: detailsHandlers } = use3DTilt({ maxTilt: 6, scale: 1.01 });
  const { ref: formRef, handlers: formHandlers } = use3DTilt({ maxTilt: 4, scale: 1.01 });
        ...
        <div className="contact-grid">
          <section className="contact-info-panel" aria-labelledby="connect-title">
            ...
            <section className="contact-form-panel" aria-label="Message Submission Form">
              <div ref={formRef} className="glass-panel form-card tilt-card" {...formHandlers}>
                {isSuccess ? (
